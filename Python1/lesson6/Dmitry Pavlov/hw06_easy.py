...
# 2017.02.13 00:16:16 checked. P.Rusanov
# Отлично!
class MyPoint:
    ''' class point (X and Y)
    '''
...
# 2017.02.13 00:16:39 checked. P.Rusanov
# Отлично!
class MyGeoHelper:
    ...
    def distance(point1, point2):
        ...
        # 2017.02.13 00:17:22 checked. P.Rusanov
        # Чуть покороче:
        # return math.sqrt((x2 - x1) ** 2 + (y2 - y1) ** 2)

        # А еще можно обратить внимание на math.hypot:
...
# 2017.02.13 00:20:00 checked. P.Rusanov
# Отлично!
class MyBaseFigure:
...
# 2017.02.13 00:21:12 checked. P.Rusanov
# Отлично!
class MyTriangle(MyBaseFigure):
    ...
    def to_string(self):        # <- скорее всего это должен быть метод  __str__ ?
...
class MyIsoscelesTrapeze(MyBaseFigure):
    ...
    def is_correct(self):       # <- скорее всего это должен быть метод  __str__ ?
